	...
	return (
		<div className="my-[50px] md:my-[130px]">
			<div className="my-container">
				<div className="md:flex border rounded-lg py-[30px] pl-[30px] pr-[47px] items-center over">
					<img
						className="bg-[#F4F4F4] py-[95px] px-[47px] rounded-lg mx-auto md:mx-0 mb-8 md:mb-0"
						src={img}
						alt=""
					/>
					<div className="ml-8">
						<h3 className="text-2xl text-[#474747] font-semibold">{title}</h3>
